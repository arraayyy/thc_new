      ...
      <View style={styles.body}>
        ...
        <View style={[styles.titleBox]}>
          ...
          <View style={[styles.cardBody]} >
            ...
            <Text ><Text style={styles.label}>Dental Caries: </Text>{dentalInfo.dentalCaries}</Text>
            <Text><Text style={styles.label}>Gingivitis:  </Text>{dentalInfo.gingivitis}</Text>
            <Text ><Text style={styles.label}>Periodontal Disease: </Text>{dentalInfo.periodontalDisease}</Text>
            <Text><Text style={styles.label}>Debris:  </Text>{dentalInfo.debris}</Text>
            <Text ><Text style={styles.label}>Calculus: </Text>{dentalInfo.calculus}</Text>
            <Text><Text style={styles.label}>Abnormal Growth: </Text>{dentalInfo.abnormalGrowth}</Text>
            <Text ><Text style={styles.label}>Cleft Lip/Palate: </Text>{dentalInfo.cleftLip}</Text>
