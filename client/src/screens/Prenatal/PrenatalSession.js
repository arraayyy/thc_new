      ...
      <View style={styles.body}>
        ...
        <View style={[styles.titleBox]}>
          ...
          <View style={styles.cardBody}>
            ...
            <Text style={styles.row}><Text style={styles.label}>Performed by : </Text> {assessmentinfo.serviceProvider}</Text>
            <Text style={styles.row}><Text style={styles.label}>Assessment of Gestational Age: </Text>{`${assessmentinfo.aog} weeks`}</Text>
